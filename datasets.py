...
class ImageDataset_sRGB(Dataset):
    def __init__(self, root, mode="train", unpaird_data="fiveK", combined=True):
        ...
        for i in range(len(set1_input_files)):
            self.set1_input_files.append(os.path.join(root,"raw",set1_input_files[i][:-1]))
            self.set1_expert_files.append(os.path.join(root,"retouched",set1_input_files[i][:-1]))
        ...
        #    self.set2_input_files.append(os.path.join(root,"raw", set2_input_files[i][:-1]))
        #    self.set2_expert_files.append(os.path.join(root,"retouched", set2_input_files[i][:-1]))
        ...
        for i in range(len(test_input_files)):
            self.test_input_files.append(os.path.join(root, "raw", test_input_files[i][:-1]))
            self.test_expert_files.append(os.path.join(root,"retouched", test_input_files[i][:-1]))
